...
describe('ApiController', () => {
  ...
  describe('getCoinById', () => {
    ...
    it('should handle invalid coin ID', async () => {
      const mockError = new HttpException('Coin not found', HttpStatus.NOT_FOUND);
  ...
  describe('getNftById', () => {
    ...
    it('should handle invalid NFT ID', async () => {
      const mockError = new HttpException('NFT not found', HttpStatus.NOT_FOUND);
  ...
  describe('getExchangeById', () => {
    ...
    it('should handle invalid exchange ID', async () => {
      ...
      await expect(controller.getExchangeById('invalid-exchange')).rejects.toThrow(
        mockError,
      );
    });
  });
