...
import {
  BsDribbble, BsFacebook, BsGithub, BsInstagram, BsTwitter,
} from 'react-icons/bs';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="col-span-1">
            <div className="flex items-center mb-4">
              <img src={cryptoLogoImage} alt="Company Logo" className="h-8 w-auto mr-3" />
          ...
          <div className="col-span-1">
            <h2 className="font-semibold mb-4 text-gray-700 text-sm">Cryptocurrencies</h2>
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-400 hover:text-gray-900 transition-colors text-sm">
                  Crypto coins
                </a>
              </li>
            </ul>
          ...
          <div className="col-span-1">
            <h2 className="font-semibold mb-4 text-gray-700 text-sm">Exchanges</h2>
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-400 hover:text-gray-900 transition-colors text-sm">
                  Crypto Exchanges
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#" className="text-gray-400 hover:text-gray-900 transition-colors text-sm">Cookie Policy</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-gray-900 transition-colors text-sm">Contact Us</a>
              </li>
            </ul>
          </div>
        </div>
