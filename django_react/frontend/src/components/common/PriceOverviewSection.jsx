...
import { faCoins, faDollarSign, faStore, faChartLine } from '@fortawesome/free-solid-svg-icons';
...
const PriceOverviewSection = ({ data }) => (
    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      <div className="flex justify-between items-center">
        ...
        <div className="text-right">
          ...
          <p className={`text-xl font-bold ${data.market_data.price_change_percentage_24h >= 0 ? 'text-green-500' : 'text-red-500'}`}>
