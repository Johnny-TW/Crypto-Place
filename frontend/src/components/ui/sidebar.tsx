...
function useSidebar() {
  ...
  if (!context) {
    console.error('useSidebar called outside SidebarProvider context');
    throw new Error(
      'useSidebar must be used within a SidebarProvider. Make sure the component is wrapped with <SidebarProvider>.'
    );
  }
