...
const Cryptocurrencies: MenuItem[] = [
  { name: 'Crypto Coins', href: '/dashboard' },
];
...
const NFT: MenuItem[] = [{ name: 'NFT Dashboard', href: '/NFTDashboard' }];
...
function Navbar(): JSX.Element {
  ...
  const { user, loginType, isLoading } = useSelector(
